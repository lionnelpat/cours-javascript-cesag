...
.. list-table::
   ...
   * - S1
     - Rappel & Env.
     - HTML/CSS, environnement, projet fil rouge
     - CM + TP
     - 3h
   * - S2
     - JS Fondations
     - Variables, types, conditions, opérateurs
     - CM + TP
     - 3h
   * - S3
     - JS Fondations
     - Fonctions, tableaux, objets, boucles
     - CM + TP
     - 3h
   * - S4
     - DOM
     - Sélection, modification, création d'éléments
     - CM + TP
     - 3h
   * - S5
     - DOM
     - Événements, propagation, délégation
     - CM + TP
     - 3h
   * - S6
     - Formulaires
     - Validation JS, regex, feedback dynamique
     - CM + TP
     - 3h
   * - S7
     - Modals & Storage
     - Modals, localStorage, partage de données
     - CM + TP
     - 3h
   * - S8
     - Fetch API
     - fetch(), async/await, données JSON, rendu dynamique
     - CM + TP
     - 3h
   * - S9
     - Librairies
     - GSAP, Chart.js, SweetAlert2, Swiper.js
     - CM + TP
     - 3h
   * - S10
     - Projet final
     - Soutenance des projets de groupe
     - Évaluation
     - 3h
